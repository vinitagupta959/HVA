...
const classicBook=new Book("Pride and Prejudice","Jane Austen","Egerton",1813,"Classic");

const sciFiBook=new Book("Dune","Frank Herbert","Chilton",1965,"Science Fiction")
